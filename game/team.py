...
class Team:
    ...
    def increment_player_points(self, player_id: int, points: int):
        self.__players[player_id].add_points(points=points)
        self.update_points(points=points)
        
    def decrement_player_points(self, player_id: int, points: int):
        self.__players[player_id].decrease_points(points=points)
        self.update_points(points=-points)
